...
/**
 * Generated class for the PatientChangepasswordPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-patient-changepassword',
  templateUrl: 'patient-changepassword.html',
})
export class PatientChangepasswordPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad PatientChangepasswordPage');
  }
